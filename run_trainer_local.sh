...
which python
# # VENV
# PY_VENV_PATH="/shared/$USER/jax-21/bin/activate"
# source ${PY_VENV_PATH}
...
num_nodes=1
# devices_per_node=32
MASTER_ADDR="samwise-odcr-p5-queue-dy-p548xlarge-2" #$(echo "$nodes" | head -n 1)
MASTER_PORT=41008
...
export NEURON_PJRT_PROCESS_INDEX=0 #${SLURM_NODEID}
